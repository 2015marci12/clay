...
Clay__MeasuredWord *Clay__AddMeasuredWord_ctx(Clay_Context* context, Clay__MeasuredWord *previousWord) {
...
Clay__MeasureTextCacheItem *Clay__MeasureTextCached_ctx(Clay_Context* context, extElementConfig *config) {
    #ifndef CLAY_WASM
